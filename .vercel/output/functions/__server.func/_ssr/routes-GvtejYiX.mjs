...
//#region node_modules/.nitro/vite/services/ssr/assets/routes-GvtejYiX.js
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
				className: "relative px-6 pt-8 md:px-12 md:pt-10",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					className: "mx-auto flex max-w-[1400px] flex-col gap-14 md:gap-20",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "nail-strip relative mt-20 w-full md:mt-24",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					className: "relative min-h-[min(52vh,520px)] w-full md:min-h-[min(58vh,600px)]",
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
							...
							children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								className: "w-full px-8 py-16 md:px-16 md:py-20 lg:px-[max(2rem,calc((100vw-1400px)/2+4rem))]",
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
										className: "eyebrow text-[#c9a87c]",
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
				className: "reel-wrap relative w-full bg-bg-secondary",
				children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
function ReelCard({ src, poster, fullBleed = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		ref: wrapRef,
		className: `reel-card relative overflow-hidden bg-black ${fullBleed ? "h-[min(85vh,880px)] w-full rounded-2xl" : ""}`,
...
function QuoteBreak() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "relative z-10 flex min-h-[100dvh] flex-col items-center justify-center px-6 py-16 md:px-12 md:py-20",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
...
var easeOut = (t) => 1 - Math.pow(1 - t, 2);
function animateValue(from, to, durationMs, ease, onUpdate, isCancelled) {
...
function BeforeAfterSlider({ before, after, label, index = 0, inView = false }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		style: {
			aspectRatio: "3 / 4",
			cursor: "ew-resize",
			transitionDelay: inView ? `${index * .12}s` : void 0
		},
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "ba-handle-track pointer-events-none absolute top-0 bottom-0 z-10 w-0.5 bg-gold",
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
...
function StatItem({ value, label }) {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "flex items-baseline gap-1.5 md:flex-row md:gap-1.5",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", {
...
function InstagramSection() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		ref: root,
		className: "bg-bg-primary px-4 py-16 sm:px-6 md:px-10 md:py-24 lg:px-14",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("a", {
									...
									children: [
										...
										/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
											className: "mt-5 hidden gap-10 text-base md:flex",
											children: [
...
function Testimonials() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", {
		className: "py-32 md:py-48 bg-bg-secondary",
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "mx-auto max-w-4xl px-6 text-center",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(SectionEyebrow, { children: "Client Stories" }),
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("h2", {
					className: "heading-display mt-6 text-text-primary text-3xl md:text-5xl mb-16",
					children: [
						"What our clients ",
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("em", {
							className: "font-accent italic text-gold",
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Swiper, {
					...
					children: TESTIMONIALS.map((t, i) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(SwiperSlide, { children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
								className: "text-gold mb-6 tracking-[0.4em]",
								children: "★★★★★"
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("blockquote", {
								className: "font-display italic text-text-primary text-2xl md:text-4xl leading-snug",
								children: [
									"\"",
									t.quote,
									"\""
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", {
								className: "eyebrow mt-8 text-text-secondary",
								children: ["— ", t.author]
							})
						]
					}) }, i))
...
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(import_jsx_runtime.Fragment, { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QuoteBreak, {}),
