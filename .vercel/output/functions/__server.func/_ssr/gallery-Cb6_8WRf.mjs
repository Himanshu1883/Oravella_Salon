...
function ColumnScrollGallery() {
	...
	(0, import_react.useEffect)(() => {
		...
		lenis?.stop();
		(async () => {
			const [{ default: LocomotiveScroll }, imagesLoadedMod] = await Promise.all([import("../_libs/locomotive-scroll.mjs").then((n) => n.t), import("../_libs/imagesloaded.mjs").then((n) => /* @__PURE__ */ __toESM(n.t()))]);
