...
import { t as require_ev_emitter } from "./ev-emitter.mjs";
//#region node_modules/imagesloaded/imagesloaded.js
var require_imagesloaded = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	/*!
	* imagesLoaded v5.0.0
	...
	*/
	(function(window, factory) {
		if (typeof module == "object" && module.exports) module.exports = factory(window, require_ev_emitter());
		else window.imagesLoaded = factory(window, window.EvEmitter);
	})(typeof window !== "undefined" ? window : exports, function factory(window, EvEmitter) {
		let $ = window.jQuery;
		...
		*/
		...
		ImagesLoaded.makeJQueryPlugin = function(jQuery) {
			...
			$.fn.imagesLoaded = function(options, onAlways) {
				return new ImagesLoaded(this, options, onAlways).jqDeferred.promise($(this));
			};
		};
...
//#endregion
export { require_imagesloaded as t };
